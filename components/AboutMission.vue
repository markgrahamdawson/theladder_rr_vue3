<template>
  <div class="bg-white md:flex w-full lg:h-[600px]">
    <!-- Left Col -->
    <div
      class="bg-offwhite text-left px-12 py-20 md:w-1/3 md:my-10 text-sm md:text-base"
    >
      <h1 class="title font-josefin font-semibold text-4xl title pb-4">
        Mission
      </h1>
    ...
    />
    <IconsDrops
      class="fill-white absolute h-40 w-40 md:h-60 md:w-60 right-[40px] -bottom-[50px] sm:-bottom-[120px] md:-bottom-[130px] lg:bottom-[10px]"
    />
    <img />
  </div>
</template>
