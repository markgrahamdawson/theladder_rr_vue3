    ...
    <div class="flex w-full">
      ...
      <div class="w-2/3 block hidden sm:block">
        <div class="flex flex-col justify-end h-full pl-20">
          <div class="flex text-1xl lg:text-2xl font-josan font-bold justify-between font-semibold text-black uppercase">
            <NuxtLink to="/about"
              class="hover:text-gray-300">About
            </NuxtLink>
            <NuxtLink to="/news"
              class="hover:text-gray-300">News
            </NuxtLink>
            <NuxtLink to="/events"
              class="hover:text-gray-300">Events
            </NuxtLink>
            <NuxtLink to="/ourSpace"
              class="hover:text-gray-300">Our Space
            </NuxtLink>
          </div>
        </div>
      </div>
